...
# Start Apache with dynamic $PORT support and clear stale package cache before boot
CMD rm -f /var/www/html/bootstrap/cache/packages.php /var/www/html/bootstrap/cache/services.php \
